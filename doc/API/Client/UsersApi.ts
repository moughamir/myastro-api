...
namespace API.Client {
    ...
    export class UsersApi {
         ...
         */
        public usersGet (exclude?: string, include?: string, order?: string, page?: string, transform?: boolean, columns?: string, filter[]?: Array<string>, satisfy?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<InlineResponse20033>> {
         ...
         */
        public usersIdDelete (id: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<number> {
         ...
         * @param id Identifier for item.
         */
        public usersIdGet (id: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<InlineResponse20033> {
            const localVarPath = this.basePath + '/users/{id}'
                .replace('{' + 'id' + '}', String(id));
         ...
         */
        public usersIdPatch (id: string, item: Item110, extraHttpRequestParams?: any ) : ng.IHttpPromise<number> {
            const localVarPath = this.basePath + '/users/{id}'
                .replace('{' + 'id' + '}', String(id));
            ...
            if (item === null || item === undefined) {
                throw new Error('Required parameter item was null or undefined when calling usersIdPatch.');
            }
            let httpRequestParams: any = {
                method: 'PATCH',
                url: localVarPath,
         ...
         * @param item Properties of item to update.
         */
        public usersIdPut (id: string, item: Item109, extraHttpRequestParams?: any ) : ng.IHttpPromise<number> {
            const localVarPath = this.basePath + '/users/{id}'
                .replace('{' + 'id' + '}', String(id));
            ...
            // verify required parameter 'item' is not null or undefined
            if (item === null || item === undefined) {
                throw new Error('Required parameter item was null or undefined when calling usersIdPut.');
            }
            let httpRequestParams: any = {
                method: 'PUT',
                url: localVarPath,
         ...
         */
        public usersPost (item: Item108, extraHttpRequestParams?: any ) : ng.IHttpPromise<number> {
            const localVarPath = this.basePath + '/users';
            ...
            // verify required parameter 'item' is not null or undefined
            if (item === null || item === undefined) {
                throw new Error('Required parameter item was null or undefined when calling usersPost.');
            }
            let httpRequestParams: any = {
                method: 'POST',
                url: localVarPath,
